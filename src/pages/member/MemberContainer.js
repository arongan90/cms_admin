...
const MemberContainer = () => {
    ...
    const memberTableColumns = [
        ...
        { id: 'portfolio', label: '포트폴리오 자산(₩)', width: 150, align: 'right', format: (value) => value.toLocaleString('ko-KR') },
        { id: 'register_date', label: '가입일', width: 100, align: 'right', format: (value) => value.toLocaleDateString('ko-KR', { year: '2-digit', month: 'numeric', day: 'numeric', }).slice(0, -1) },
